...
const insertClaim = async (req, res) => {
    try {
        ...
        let text = "Halo%20emam%20Indonesia%20%21%0A%0APerkenalkan%20saya%20" + data.ownerName + "%20sebagai%20pemilik%20dari%20tempat%20makan%20" + data.placeName + "%2C%20saya%20ingin%20mengklain%20tempat%20makan%20saya%20ini.%20Untuk%20data%20syarat%20klaimnya%2C%20adalah%20%3A%0A%0ANama%20Tempat%20Makan%20%3A%20" + data.placeName + "%0ANama%20Pemilik%20%3A%20" + data.ownerName + "%0ANomor%20Telepon%20%3A%20" + data.ownerPhoneNumber + "%0AUsername%20%3A%20" + data.ownerUsername + "%0ASaya%20tunggu%20kabar%20selanjutnya%20dari%20emam%20Indonesia.%20Atas%20perhatiannya%2C%20saya%20ucapkan%20terima%20kasih%20%21"
        //Send to Email Area
        return res.json({
